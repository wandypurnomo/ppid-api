...
{
    public function index(Request $request, Dip $information){
        ...
        $data = paginatedData($information->paginate(10),"dip");
    ...
    public function getYear(Dip $information){
    ...
    public function registrationSummary(PermohonanInformasi $informasi){
        ...
        $x->selectRaw(
            ...
            (SELECT COUNT(*) from permohonan where status=0 and YEAR(created_at) = year) as sedang_proses,
    ...
    public function getStatistic(){
        $arr = [
            "jumlah_dokumen" => Dip::all()->count(),
            "jumlah_permohonan" => PermohonanInformasi::all()->count(),
            "jumlah_unduhan" => Dip::all()->sum("downloaded"),
    ...
    public function getLatestInfo(Dip $information){
    ...
    public function getMostInfo(Dip $information){
